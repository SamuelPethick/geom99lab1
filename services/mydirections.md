...
```
[[[https://YourDirectionsApiURLGoesHere](https://maps.googleapis.com/maps/api/directions/json?origin=Batman+Turkey&waypoints=Palm+Jebel+Ali&destination=Burj+Khalifa&mode=walking&key=AIzaSyCM-WWHYHIKY-do4kquMy9Z4wQaQx51AuE)](https://maps.googleapis.com/maps/api/directions/json?origin=Batman+Turkey&waypoints=Palm+Jebel+Ali&destination=Burj+Khalifa&mode=walking&key=AIzaSyCM-WWHYHIKY-do4kquMy9Z4wQaQx51AuE)](https://maps.googleapis.com/maps/api/directions/json?origin=Batman+Turkey&waypoints=Palm+Jebel+Ali&avoid=ferries&destination=Burj+Khalifa&mode=walking&key=AIzaSyCM-WWHYHIKY-do4kquMy9Z4wQaQx51AuE)
```
